...
output_file2_xf = './output02/' + file2_xf.split('/')[-1]
...
output_file1_pts = './output02/' + file1.split('/')[-1]
output_file1_xf = './output02/' + file1_xf.split('/')[-1]
output_file2_pts = './output02/' + file2.split('/')[-1]
output_file2_xf = './output02/' + file2_xf.split('/')[-1]
